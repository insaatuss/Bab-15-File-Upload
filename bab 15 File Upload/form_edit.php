				...
				<form action="action_edit.php" method="POST" enctype="multipart/form-data">
					...
					<?php if ( !is_null($foto) && !empty($foto)) : ?>
						...
						<div class="form-group mb-2">
							<img src="<?=$foto?>" alt="" class="preview" style="height:120px; width:120px">
							<a href="hapus_foto.php?id=<?=$id_barang?>">Delete</a>
						</div>
					...
					<?php endif; ?>
						...
						<div class="form-group mb-2">
							...
							<input type="text" id="ID_barang" value="<?=$_GET['id_barang'];?>" name="ID_barang" class="form-control" placeholder="Ex: ID001" required>
						</div>

						<div class="form-group mb-2">
							<label for="name">Nama Barang</label>
							<input type="text" id="name" value="<?=$_GET['nama_barang'];?>" class="form-control" name="name" placeholder="Masukkan Nama Barang" required> 
							
						</div>

						<div class="form-group mb-2">
							<label for="harga">Harga</label>
							<input type="number" id="harga" value="<?=$_GET['harga'];?>" name="harga" class="form-control" placeholder="ex: 65000" required>
						</div>
